...
<!doctype html>
<html lang="es">
    <?php $title = "Gestion | Periodo Academico"; include 'head_gestion.php'; ?>
    <body>
                ...
                <div class="card bg-none border-0 mb-5">
                    <div class="container mt-5 mb-5">
                        <div style="background: #7952B3 ">
                            <h4 style="color: white;"><i class="bi bi-pencil-square fst-normal fs-2 mx-2"></i>Gestion | Periodo Academicos - Nivel</h4>
                        </div>
                        <div class="col mt-5 mb-5">
                            <h3>Lista de Periodos Academicos | Nivel:</h3>
                            <div id="mensaje"></div>
                        ...
                        <table  class="table table-striped align- table-hover container">
                            ...
                            <thead class="text-center">
                                <tr class=" bg-body " >
                                    ...
                                    <th class="text-start">Descripcion periodo Academico</th>
                                    <th>Estado</th>
                                </tr>
                            </thead>
                                ...
                                if ($result) {
                                    if ($result > 0) {
                                        foreach ($result as $datos) {
                                            $Id_Pa = $datos->idtb_periodo_academico;
                                            $Descripcion = $datos->descripcion;
                                            $Estado = $datos->estado;
                                            ?>
                                            <tr>
                                                <td class="text-start"><?php echo $Id_Pa ?></td>
