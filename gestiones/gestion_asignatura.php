...
<!doctype html>
<html lang="es">
    <?php $title = "Gestion | Asignatura"; include 'head_gestion.php'; ?>
    <body>
                ...
                <div class="card bg-none border-0 mb-5">
                    <div class="container mt-5 mb-5">
                        <div style="background: #7952B3 ">
                            <h4 style="color: white;"><i class="bi bi-pencil-square fst-normal fs-2 mx-2"></i>Gestion | Asignaturas</h4>
                        </div>
                        ...
                        <table  class="table table-striped align- table-hover container">
                            ...
                            <thead class="text-center">
                                <tr class=" bg-body " >
                                    ...
                                    <th class="text-start">Nombre Asignatura</th>
                                    <th>Estado</th>
                                </tr>
                            </thead>
                                ...
                                if ($result) {
                                    if ($result > 0) {
                                        foreach ($result as $datos) {
                                            $Id_As = $datos->idtb_asignatura;
                                            $Descripcion = $datos->descripcion;
                                            $Estado = $datos->estado;
                                            ?>
                                            <tr>
                                                <td class="text-start"><?php echo $Id_As ?></td>
